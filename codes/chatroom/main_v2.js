...
function keeponoff(getstatus){
	...
	if(getstatus=="Appear Offline"){
		...
		document.getElementById("me_offline").innerHTML="<font color=WHITE>&nbsp;&nbsp;&nbsp;*You are now Offline but you are are still able to send and receive Offline messages ...</font>";
		...
		//BELOW id "friend_offline" is used because POTS automatically changes this tag...		
...
//////////////////////////////////////////////////////////////////////////////
// URL Generator for ajax_master.php to function
...
if(buddy_status=="online" && userstatus=="online"){
	ptts="ptts=yes";
}

url = "ajax/ajax_master.php?"+ sots +"&"+ pots +"&"+ stts +"&"+ ptts +"&"+ show;
return url;
}
...
///////////////////////////END/////END////END/////////////////////////////////////////////////////////////////////
///END///////////////////LOOPERS LOOPERS 
//

function null_innerhtml(eid){//eid= element ID 
