function create_menu(basepath)
{
	...
	document.write(
		...
		'<ul>' +
		'<li><a href="'+base+'index.php">User Guide Home</a></li>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'installation/index.php">Installation Instructions</a></li>' +
		...
		'<h3>Tutorial</h3>' +
		'<ul>' +
			'<li><a href="'+base+'tutorial/index.php">Introduction</a></li>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'doc_style/index.php">Writing Documentation</a></li>' +
		'</ul>' +
		...
		'<li><a href="'+base+'database/index.php">Database Class</a></li>' +
		'<li><a href="'+base+'libraries/javascript.html">Javascript Class</a></li>' +
		'</ul>' +
